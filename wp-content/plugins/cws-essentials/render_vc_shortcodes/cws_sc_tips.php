...
function cws_vc_shortcode_sc_tips ( $atts = array(), $content = "" ){
	$defaults = array(
		/* -----> GENERAL TAB <----- */
		"image"							=> "",
		"values"						=> "",
	...
	if( !empty($values) ){
		$out .= "<div id='".$id."' class='cws_tips_module ".esc_attr($el_class)."'>";

			$out .= "<div class='cws_tips_wrapper'>";
				...
				foreach( $values as $value ){
					...
					$out .= "<a href='".esc_url($link)."' class='cws_tip' style='".$local_styles."'>";
