<?php
function cws_vc_shortcode_sc_menu_list ( $atts = array(), $content = "" ){
	$defaults = array(
		/* -----> GENERAL TAB <----- */
		"values"						=> "",
		"el_class"						=> "",
	...
	if( !empty($values) ){
		$out .= "<div id='".$id."' class='cws_menu_list_module ".esc_attr($el_class)."'>";

			$out .= "<ul class='cws_menu_list_wrapper'>";
...
add_shortcode( 'cws_sc_menu_list', 'cws_vc_shortcode_sc_menu_list' );
