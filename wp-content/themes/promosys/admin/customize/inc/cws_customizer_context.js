( function( api ) {
    ...
    api.bind( 'ready', function() {
        ...
        /* -----------> Rewrite Permalinks <------------ */
        jQuery('#_customize-input-cws_portfolio_slug, #_customize-input-cws_staff_slug').on('keydown', function() {
            jQuery('#_customize-input-cws_reset_permalinks').val('true').change();
        });
            ...
            if( typeof jQuery(el).data('depend-by') !== "undefined" ){
                ...
                if( 
                    ...
                    observable_control.on('input', function(){
                        promosys_reactive_dependency( jQuery(this), depend_operator, depend_value, jQuery(el), depend_default );
                    });
                } else {
        ...
        function promosys_reactive_dependency( observable, depend_operator, depend_value, changeable, depend_default ){
        ...
        /* -----------> Sneaky Select <------------ */
        jQuery('li[id*="customize-control-widget_cws_icon_list"]').on('click', function(){
