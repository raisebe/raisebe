<?php 
	...
	$params = cws_ext_merge_arrs( array(
		...
		array(
			array(
				"type"				=> "attach_image",
				"heading"			=> esc_html_x( 'Logotype', 'backend', 'promosys' ),
				"param_name"		=> "image",
				"description"		=> esc_html_x( 'If empty, logotype will be taken from customizer.', 'backend', 'promosys' ),
			),
			array(
				"type"				=> "checkbox",
				"param_name"		=> "retina",
				"value"				=> array( esc_html_x( 'Retina', 'backend', 'promosys' ) => true ),
                "edit_field_class" 	=> "cws-checkbox vc_col-xs-12",
				"std"				=> "1"
			),
			array(
				"type"				=> "textfield",
				"heading"			=> esc_html_x( 'Width', 'backend', 'promosys' ),
				"description"		=> esc_html_x( 'Dimensions override retina settings.', 'backend', 'promosys' ),
				"param_name"		=> "width",
			...
			array(
				"type"				=> "textfield",
				"heading"			=> esc_html_x( 'Height', 'backend', 'promosys' ),
				"description"		=> esc_html_x( 'Dimensions override retina settings.', 'backend', 'promosys' ),
				"param_name"		=> "height",
				"edit_field_class" 	=> "vc_col-xs-6",
				"value"				=> ""
	...
	/* -----> MODULE DECLARATION <----- */
	vc_map( array(
		"name"				=> esc_html_x( 'CWS Logotype', 'backend', 'promosys' ),
		"base"				=> "cws_sc_logo",
		'category'			=> "By CWS",
		"icon"     			=> "cws_icon",
		"weight"			=> 80,
	...
	if ( class_exists( 'WPBakeryShortCode' ) ) {
	    class WPBakeryShortCode_CWS_Sc_Logo extends WPBakeryShortCode {
	    }
	}
?>