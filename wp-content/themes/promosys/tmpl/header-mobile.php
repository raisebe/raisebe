...
<!-- #site-header-mobile -->
<div id="site-header-mobile" class="site-header-mobile<?php echo esc_attr($header_classes); ?>">
    <div class="header-bg"<?php echo (!empty($header_extra_styles) ? ' style="' . esc_attr($header_extra_styles) . '"' : ''); ?>></div>
	...
	<div class="header-content">
			...
			<div class="container">
				<div class="site_logotype">
					<a href="<?php echo esc_url(home_url( '/' )) ?>">
						<?php promosys_logo('mobile_top_bar_logotype', 'mobile_top_bar_logo_dimensions', 'h3') ?>
					</a>
				</div>
		...
		<div class="menu-box container">
			<div class="menu-box-logo">
				<a href="<?php echo esc_url( home_url('') ) ?>">
					<?php promosys_logo('mobile_menu_logotype', 'mobile_menu_logo_dimensions', 'h3') ?>
				</a>
			</div>
            ...
            <?php if( !empty(get_theme_mod('top_bar_number')) || !empty(get_theme_mod('top_bar_email')) || !empty(get_theme_mod('top_bar_address')) ) : ?>
            <div class="menu-box-info">
                <?php if( !empty(get_theme_mod('top_bar_number')) ) : ?>
                <div class="menu-box-info-item">
            ...
            <!-- Extra Button Place -->
            <?php if( get_theme_mod('mobile_extra_button') && !empty(get_theme_mod('mobile_extra_button_title')) ) : ?>
                <div class="extra-button">
                    <a href="<?php echo !empty(get_theme_mod('mobile_extra_button_url')) ? esc_url(get_theme_mod('mobile_extra_button_url')) : '#'; ?>" class="cws_button small simple">
                        <span><?php echo esc_html(get_theme_mod('mobile_extra_button_title')); ?></span>
                    </a>
                </div>
            <?php endif; ?>
            ...
            <?php
                if( function_exists('wpm_language_switcher') && get_theme_mod('lang_switcher_mobile') ){ ?>
		...
		<?php if( !is_front_page() && !is_404() && cws_get_metabox('title_area_remove') != 'on' ) : ?>
			<?php
			...
			<?php if( empty(cws_get_metabox('slider_shortcode')) ): ?>
				<div class="page_title_container" <?php echo (!empty($title_extra_styles) ? ' style="' . esc_attr($title_extra_styles) . '"' : '' );
				?>>
                    ...
                    <div class="page_title_wrapper container">
                        ...
                        <?php endif; ?>
                        <?php if( is_single() && strripos($title_hide, 'meta') === false ) : ?>
